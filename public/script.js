...
// OVERLAY FUNCTION WHEN SHARE BUTTON IS CLICKED
function overlay(url){
  let overlay = document.getElementById("overlay");
  overlay.style.display = "flex";
  overlay.style.alignItems = "center";
  let link = document.getElementById("link");
  link.href = "./display.html?id="+url;
  link.textContent = "./display.html?id="+url;
}
...
document.querySelector('#save').addEventListener('click', () => {
  ...
  xmlhttp.open("POST", '/sharePostcard');
  ...
  xmlhttp.onloadend = function(e) {
    ...
    // window.location = "/display.html?id="+xmlhttp.responseText;
...
document.querySelector('#imgUpload').addEventListener('change', () => {
    ...
    xhr.onloadend = function(e) {
        ...
        newImage.src = "http://ecs162.org:3000/images/bhdinh/"+selectedFile.name;
        // newImage.src = "https://foggy-climbing-carob.glitch.me/images/"+selectedFile.name;
